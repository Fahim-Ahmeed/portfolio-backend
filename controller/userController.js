...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    linkedInURL,
    avatar: {
        public_id: cloudinaryResponseForAvatar.public_id, // Correct variable name
        url: cloudinaryResponseForAvatar.secure_url, // Correct variable name
    },
    resume: {
        public_id: cloudinaryResponseForResume.public_id, // Correct variable name
        url: cloudinaryResponseForResume.secure_url, // Correct variable name
    },
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "66d9337e1025618aa80894e8";
